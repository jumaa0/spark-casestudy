...
from pyspark.sql.functions import from_json, col, to_date, to_timestamp, hour, expr
...
# Handling null values by filling them with appropriate default values
...
# Ensure the totalAmount is casted to float to avoid type mismatch in Hive
cleaned_df = cleaned_df.withColumn("totalAmount", col("totalAmount").cast("float"))
